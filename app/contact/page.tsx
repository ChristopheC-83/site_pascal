        ...
        <section className="bg-slate-950 text-white">
          ...
          <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20 lg:px-10 lg:py-24">
            ...
            <p className="mt-6 max-w-3xl text-base leading-8 text-slate-300 sm:text-lg">
              {" "}
              Vous avez une installation à prévoir, un équipement à remplacer ou
              une panne à résoudre ? Décrivez-moi votre besoin afin que je
              puisse vous apporter un premier avis et préparer un devis
              adapté.{" "}
            </p>{" "}
            <a
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-5 sm:px-8 lg:grid-cols-[1.45fr_0.75fr] lg:gap-20 lg:px-10">
            ...
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-slate-600">
                {" "}
                Quelques informations sur votre équipement, votre projet ou la
                panne rencontrée me permettront de mieux préparer notre
                échange.{" "}
              </p>{" "}
            ...
            <aside className="border-t border-slate-300 pt-8 lg:border-l lg:border-t-0 lg:pl-10 lg:pt-0">
              ...
              <address className="mt-6 text-base not-italic leading-8 text-slate-700">
                ...
                <p>
                  {" "}
                  4 rue de la Manzanille <br /> 30620 UCHAUD{" "}
                </p>{" "}
                <div className="mt-5">
                  {" "}
                  <p>
              ...
              <p className="mt-8 border-l-2 border-amber-600 pl-5 text-sm leading-7 text-slate-600">
                {" "}
                J’interviens autour d’Uchaud, entre Nîmes et Montpellier, dans
                le Gard et l’Hérault selon la nature du projet.{" "}
              </p>{" "}
            </aside>{" "}
          </div>{" "}
        </section>{" "}
