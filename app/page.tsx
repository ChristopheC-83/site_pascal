  ...
  return (
    <>
      ...
      <main>
        <section
          id="accueil"
          className="relative isolate flex min-h-168 items-end overflow-hidden sm:min-h-180 lg:min-h-[calc(100svh-9.5rem)]"
        >
          <Image
          ...
          <div className="mx-auto w-full max-w-7xl px-5 pb-16 pt-28 sm:px-8 sm:pb-20 lg:px-10 lg:pb-24">
            <div className="max-w-3xl">
              <p className="mb-5 flex items-center gap-3 text-xs font-bold uppercase tracking-[0.2em] text-amber-400 sm:text-sm">
                ...
                Artisan basé à Uchaud
              </p>

              <h1 className="font-heading text-4xl font-bold leading-[1.08] tracking-tight text-white sm:text-5xl lg:text-6xl xl:text-7xl">
                Antennes, visiophones, portails et systèmes de sécurité
              </h1>

              <p className="mt-6 max-w-2xl text-base leading-7 text-slate-200 sm:text-lg sm:leading-8">
                Installation, remplacement et dépannage de vos équipements
                autour d’Uchaud, entre Nîmes et Montpellier.
              </p>

              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/contact"
                  className="inline-flex min-h-14 items-center justify-center bg-amber-500 px-7 text-sm font-bold uppercase tracking-widest text-slate-950 transition-colors hover:bg-amber-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                >
                  Demander un devis
                </Link>
                ...
                <a
                  ...
                  className="inline-flex min-h-14 items-center justify-center border border-white/60 bg-slate-950/20 px-7 text-sm font-bold tracking-widest text-white transition-colors hover:bg-white hover:text-slate-950 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
                >
                  06 07 56 85 38
                </a>
              </div>
        ...
        <section
          id="prestations"
          className="scroll-mt-8 bg-stone-50 py-20 sm:py-24 lg:py-28"
        >
          <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
            <div className="mb-10 grid gap-5 lg:grid-cols-2 lg:items-end lg:gap-16">
              <div>
                ...
                <h2 className="mt-3 font-heading text-3xl font-bold tracking-tight text-slate-950 sm:text-4xl lg:text-5xl">
                  Des solutions adaptées à votre installation
                </h2>
              </div>

              <p className="max-w-xl text-base leading-7 text-slate-600 lg:justify-self-end">
                J&apos;interviens pour installer, remplacer, régler ou dépanner
                vos équipements d’accès, de réception TV et de sécurité, dans
                l’habitat comme dans les locaux professionnels.
              </p>
            </div>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-5 sm:px-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center lg:gap-20 lg:px-10">
            <div className="relative min-h-80 overflow-hidden bg-slate-200 sm:min-h-112">
              ...
              <div className="absolute bottom-0 left-0 bg-slate-950 px-6 py-5 text-white">
                <span className="block text-xs font-bold uppercase tracking-[0.16em] text-amber-400">
                  Basé à
                </span>

                <span className="mt-1 block font-heading text-2xl font-bold">
                  Uchaud
                </span>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="mt-6 text-base leading-8 text-slate-600">
                Installé à Uchaud,&apos;interviens entre Nîmes et Montpellier
                pour vos projets d’antenne, de visiophone, de motorisation de
                portail, d’automatisme et de sécurité.
              </p>

              <p className="mt-4 text-base leading-8 text-slate-600">
                Chaque demande est étudiée selon votre équipement existant, vos
                besoins et les contraintes du chantier, afin de proposer une
                solution claire, adaptée et durable.
              </p>

              <div
                className="mt-8 flex flex-wrap gap-2"
                aria-label="Principaux secteurs d'intervention"
              >
                {[
                  "Uchaud",
                  "Secteur de Nîmes",
        ...
        <section id="contact" className="scroll-mt-8 bg-amber-500">
          <div className="mx-auto flex max-w-7xl flex-col gap-8 px-5 py-14 sm:px-8 lg:flex-row lg:items-center lg:justify-between lg:px-10 lg:py-16">
            <div>
              ...
              <h2 className="mt-2 font-heading text-3xl font-bold text-slate-950 sm:text-4xl">
                Une installation à prévoir ou un équipement en panne ?
              </h2>

              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-800">
                Décrivez votre projet ou votre problème pour obtenir un premier
                échange et une estimation adaptée à votre installation.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:shrink-0">
              <a
                href="tel:+33607568538"
                className="inline-flex min-h-14 items-center justify-center bg-slate-950 px-6 text-sm font-bold tracking-[0.08em] text-white transition-colors hover:bg-slate-800"
              >
                Appeler Pascal ALBERT
              </a>
