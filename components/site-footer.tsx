      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-12 sm:px-8 md:grid-cols-2 lg:grid-cols-[1.2fr_1fr_1fr] lg:px-10 lg:py-16">
        <div>
          ...
          <p className="mt-4 max-w-sm text-sm leading-6 text-slate-400">
            Installation et dépannage en domotique, basse tension, automatismes et
            sécurité entre Nîmes et Montpellier.
          </p>
        </div>

        <address className="text-sm not-italic leading-7">
          <p className="mb-2 font-bold uppercase tracking-[0.12em] text-white">
            Coordonnées
          </p>
          <p>
          ...
          <a className="block hover:text-white" href="tel:+33607568538">
            06 07 56 85 38
          </a>
          <a
